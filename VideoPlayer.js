...
export default class VideoPlayer extends Component {
    ...
    */
    ...
    hideControlAnimation() {
        Animated.parallel([
            ...
            Animated.timing(
                this.animations.middleControl.opacity,
                { toValue: 0 }
            ),
        ]).start();
    }
    ...
    */
    ...
    renderMiddleControls() {
        ...
        const stepForwardControl = this.props.disablePlayPause ? this.renderNullControl() : this.renderStepForwad();
        const stepBackwardControl = this.props.disablePlayPause ? this.renderNullControl() : this.renderStepBackward();
    ...
    renderStepForwad() {
        return this.renderControl(
            <Image
                ...
                style={ styles.controls.stepFoward }
            />,
            (e) => this.stepForward(),
            styles.controls.stepFoward
        );
    }
    ...
    renderStepBackward() {
        return this.renderControl(
            <Image
                ...
                style={ styles.controls.stepBackward }
            />,
            (e) => this.stepBackward(),
            styles.controls.stepBackward
        );
    }
    /**
